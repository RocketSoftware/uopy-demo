...
*	Copyright (C) Rocket Software, Inc.  1993-2015
...
try:
   ...
   print()
   print("Error: Unable to continue this example.")
   print("The 'tkinter' packages were not found.")
   print("Please see the U2 Python User Guide for more details.")
   print()
   quit()
